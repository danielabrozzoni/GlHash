        ...
        (((glm::uint32)(glm::uint8)(ch1) <<  8) & 0x0000FF00) | \
         ((glm::uint32)(glm::uint8)(ch0)        & 0x000000FF) )
            ...
            inline texture2D loadDDS10
                ...
                if (HeaderDesc.format.flags & loader_dds9::detail::GLI_DDPF_FOURCC &&
                ...
                std::size_t MipMapCount = (HeaderDesc.flags & loader_dds9::detail::GLI_DDSD_MIPMAPCOUNT)
            ...
            inline void saveDDS10
                ...
                glm::uint32 Caps = loader_dds9::detail::GLI_DDSD_CAPS | loader_dds9::detail::GLI_DDSD_HEIGHT |
                                   loader_dds9::detail::GLI_DDSD_WIDTH | loader_dds9::detail::GLI_DDSD_PIXELFORMAT;

                loader_dds9::detail::ddsHeader HeaderDesc;
                HeaderDesc.size = sizeof(loader_dds9::detail::ddsHeader);
                HeaderDesc.flags = Caps |
                                   (loader_dds9::detail::isCompressed(Image) ? loader_dds9::detail::GLI_DDSD_LINEARSIZE
                                                                             : loader_dds9::detail::GLI_DDSD_PITCH) |
                                   (Image.levels() > 1 ? loader_dds9::detail::GLI_DDSD_MIPMAPCOUNT : 0); //659463;
                ...
                HeaderDesc.surfaceFlags = loader_dds9::detail::GLI_DDSCAPS_TEXTURE |
                                          (Image.levels() > 1 ? loader_dds9::detail::GLI_DDSCAPS_MIPMAP : 0);
